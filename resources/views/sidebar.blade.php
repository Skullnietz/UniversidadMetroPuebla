...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <body class="clickup-chrome-ext_installed">
    ...
    <!-- End Google Tag Manager (noscript) -->
          ...
          <div class="wrapper ">
            <div class="sidebar" data-color="orange" data-background-color="red" data-image="{{ asset('material') }}/img/sidebar-1.jpg">
              <!--
              ...
              <div class="logo">
                <a href="https://creative-tim.com/" class="simple-text logo-normal">
                  <img src="{{asset('material/img/Logo.png')}}" width="180" alt="">
                  
                </a>
              </div>
              <div class="sidebar-wrapper">
                <ul class="nav">
                  <li class="nav-item @yield('itemdashboard')">
                  ...
                  <li class="nav-item">
                    ...
                    <div class="collapse @yield('itemcollapsableuser')"" id="laravelExample">
                      <ul class="nav">
                  ...
                  <li class="nav-item @yield('itemtablelist')">
                    <a class="nav-link" href="{{ route('table') }}">
                      <i class="material-icons">content_paste</i>
                        <p>{{ __('Tabla') }}</p>
                    </a>
                  </li>
                  <li class="nav-item @yield('itemtypography')">
                    <a class="nav-link" href="{{ route('typography') }}">
                      <i class="material-icons">library_books</i>
                        <p>{{ __('Tipografia') }}</p>
                    </a>
                  </li>
                  <li class="nav-item @yield('itemicons') ">
                    <a class="nav-link" href="{{ route('icons') }}">
                      <i class="material-icons">bubble_chart</i>
                      <p>{{ __('Iconos') }}</p>
                    </a>
                  </li>
                  <li class="nav-item @yield('itemnotificarions')">
...
<div class="container-fluid">
  <div class="navbar-wrapper">
    <a class="navbar-brand" href="#">@yield('sidebartitle')</a>
  </div>
